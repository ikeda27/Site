...
--
-- Máquina: 127.0.0.1
-- Data de Criação: 12-Maio-2018 às 22:00
...
CREATE TABLE IF NOT EXISTS `destaques_produtos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `metodos_pgto` (
...
CREATE TABLE IF NOT EXISTS `tbl_meio_pgto` (
...
CREATE TABLE IF NOT EXISTS `tipo_torneio` (
...
CREATE TABLE IF NOT EXISTS `usuario_mesa` (
  `cod_mesa` int(11) DEFAULT NULL,
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `login`, `senha`, `nivel_acesso_id`, `created`, `modified`, `endereco`, `documento`, `telefone`, `plano`, `saldo`, `nascimento`, `flag_user_ativo`, `cod_clube`) VALUES
(1, 'Cesar Szpak', 'admin@ikedateste.com.br', 'admin', '123', 1, '2015-09-19 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1),
(2, 'Kelly1', 'kelly@ikedateste.com.br', 'kelly', '123', 2, NULL, '2015-09-26 13:20:53', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1),
(3, 'Gabriely', 'cesarszpak@gmail.com', 'gabriely', '123', 2, '2015-09-20 21:48:49', '2015-09-26 13:21:42', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1),
(6, 'Novo Teste Cadastro V2', 'email@v2.com.br', 'cadv2', '123', 1, '2017-12-14 22:43:49', '2017-12-14 22:43:49', 'rua cadastro v2', '12345678910', '14999999999', 4, '50000', '2017-10-21 00:00:00', 1, 0),
(7, 'Victor Cesar', 'vorsolan@hotmail.com', 'vcborsolan', 'MMM1112345', 1, '2018-01-23 22:11:56', '2018-01-23 22:11:56', 'rua do caralho', '43645821821', '666', 5, '666', '1994-08-24 00:00:00', 1, 1),
(8, 'Usuario 21-04', 'usuario21@21.com', 'u21', '123123', 2, '2018-04-21 14:16:33', '2018-04-21 14:16:33', 'usuario 21 ', '212.121.212-12', '(21) 21212-1212', 5, '10.000,00', '21/12/1921', 1, 1),
(9, 'teste teste teste', 'teste@teste2222.com.br', 'teste222', 'teste222', 1, '2018-04-21 16:51:28', '2018-04-21 16:51:28', 'adfdfdsfsfd', '123.123.123-12', '(12) 31231-2311', 2, '123.123,12', '12/12/2000', 1, 1);
...
CREATE TABLE IF NOT EXISTS `venda_dados` (
