...
--
-- Máquina: 127.0.0.1
-- Data de Criação: 08-Abr-2018 às 06:16
...
INSERT INTO `cadastro_torneio` (`cod_cadastro_torneio`, `flg_ranking`, `tipo_torneio`, `peso_torneio`, `nome_torneio`, `situacao_id`) VALUES
(1, '0', 1, 1, 'torneio do inferno', 1),
(2, '1', 1, 1, 'torneio_teste', 1);
...
CREATE TABLE IF NOT EXISTS `partida` (
  ...
  `colocacao_player` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `partida` (`cod_partida`, `data_partida`, `dealer`, `qtd_rebuy`, `qtd_entrada`, `cod_player`, `qtd_addon`, `cod_mesa`, `cod_torneio`, `colocacao_player`) VALUES
(1, '2018-03-27', NULL, 1, 1, 1, 0, 1, 4, 0),
(1, '2018-03-27', NULL, 1, 1, 3, 0, 1, 4, 0),
(1, '2018-03-27', NULL, 1, 1, 2, 0, 1, 4, 0);
...
CREATE TABLE IF NOT EXISTS `torneio` (
  `cod_torneio` int(11) NOT NULL AUTO_INCREMENT,
  `vlr_entrada` varchar(1000) COLLATE utf8_bin NOT NULL,
  `vlr_rebuy` varchar(1000) COLLATE utf8_bin NOT NULL,
  `vlr_addon` varchar(1000) COLLATE utf8_bin NOT NULL,
  `cod_club` int(11) NOT NULL,
  `sit_torneio` int(11) NOT NULL,
  `qtd_max_rebuy` double NOT NULL,
  `qtd_max_addon` double NOT NULL,
  `qtd_max_player_mesa` int(11) NOT NULL,
  `tipo_torneio` int(11) NOT NULL,
  `nome_torneio` varchar(100) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `torneio` (`cod_torneio`, `vlr_entrada`, `vlr_rebuy`, `vlr_addon`, `cod_club`, `sit_torneio`, `qtd_max_rebuy`, `qtd_max_addon`, `qtd_max_player_mesa`, `tipo_torneio`, `nome_torneio`) VALUES
(1, '150', '15', '150', 1, 1, 15, 150, 15, 1, ''),
(12, '10', '10', '10', 1, 1, 10, 10, 4, 2, 'filha da puta'),
(11, '10', '10', '10', 1, 1, 10, 10, 4, 2, 'filha da puta'),
(13, '10', '10', '10', 1, 1, 10, 10, 4, 2, 'filha da puta');
...
INSERT INTO `vendas` (`cod_venda`, `cod_clube`, `cod_cliente`) VALUES
(1, 1, 7),
(2, 1, 7);
