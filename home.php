<?php
	...
	$resultado=mysqli_query($conectar, "SELECT * FROM carousels ORDER BY ordem asc LIMIT 3");
...
?>	
		...
		while($linhas = mysqli_fetch_array($resultado)){
			...
			if($controle == 1){ ?>
				<div class="item active">
					<a href="#"><img class="first-slide" src="<?php echo $imagem;?>" alt="First slide"></a>
				</div>
			<?php }elseif($controle == 2){?>
				<div class="item">
					<a href="#"><img class="second-slide" src="<?php echo $imagem;?>" alt="First slide"></a>
				</div>
			<?php }elseif($controle == 3){?>
				<div class="item">
					<a href="#>"><img class="third-slide" src="<?php echo $imagem;?>" alt="First slide"></a>
				</div>
			<?php }
			$controle = $controle + 1;
		} ?>
    ...
    <div class="container marketing">
      ...
      <hr class="featurette-divider">
		<?php
		//Pesquisar o id dos produtos em destaque no nivel 1 página principal
		$resultado_prod_dest=mysqli_query($conectar, "SELECT * FROM destaques_produtos WHERE nivel_dois='1' ORDER BY ordem ASC LIMIT 3");
		$linhas_prod_dest=mysqli_num_rows($resultado_prod_dest);
