...
--
-- Máquina: 127.0.0.1
-- Data de Criação: 01-Mar-2018 às 23:21
...
CREATE TABLE IF NOT EXISTS `cadastro_torneio` (
  ...
  `flg_ranking` int(11) DEFAULT NULL,
  `tipo_torneio` int(11) DEFAULT NULL,
  `peso_torneio` int(11) DEFAULT NULL,
  `vlr_entrada` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `qtd_max_rebuy` int(11) DEFAULT NULL,
  `vlr_rebuy` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `qtd_max_addon` int(11) DEFAULT NULL,
  `vlr_addon` varchar(20) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `cadastro_torneio` (`cod_cadastro_torneio`, `flg_ranking`, `tipo_torneio`, `peso_torneio`, `vlr_entrada`, `qtd_max_rebuy`, `vlr_rebuy`, `qtd_max_addon`, `vlr_addon`, `nome_torneio`, `qtd_max_player_mesa`) VALUES
(4, 0, 3, 2, '200', 2, '300', 4000, '1213.1', 'teste', 8),
(3, 0, 3, 2, '200', 2, '300', 4000, '1213.1', 'teste', 8),
(5, 0, 3, 2, '200', 2, '300', 4000, '1213.1', 'teste', 8);
...
(17, 'coca cola 2 litro', 'coca cola garrafa la gruessa', 'engarrafado fornecido pela spaipa', '9,90', 'refrigerante', 'description', 'coca cola', 'coca_teste.PNG', 2, '2018-02-13 19:14:15', '2018-02-13 19:14:15', 4);
...
CREATE TABLE IF NOT EXISTS `torneio` (
  ...
  `saldo_torneio` float DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `clube_inicial` int(11) DEFAULT NULL,
  `clube_ativo` varchar(1000) DEFAULT NULL,
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `login`, `senha`, `nivel_acesso_id`, `created`, `modified`, `endereco`, `documento`, `telefone`, `plano`, `saldo`, `nascimento`, `flag_user_ativo`, `clube_inicial`, `clube_ativo`, `ranking`) VALUES
(1, 'Cesar Szpak', 'admin@ikedateste.com.br', 'admin', '123', 1, '2015-09-19 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
(2, 'Kelly1', 'kelly@ikedateste.com.br', 'kelly', '123', 2, NULL, '2015-09-26 13:20:53', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
(3, 'Gabriely', 'cesarszpak@gmail.com', 'gabriely', '123', 2, '2015-09-20 21:48:49', '2015-09-26 13:21:42', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
(6, 'Novo Teste Cadastro V2', 'email@v2.com.br', 'cadv2', '123', 1, '2017-12-14 22:43:49', '2017-12-14 22:43:49', 'rua cadastro v2', '12345678910', '14999999999', 4, 50000, '2017-10-21 00:00:00', 1, NULL, NULL, 0),
(7, 'Victor Cesar', 'vorsolan@hotmail.com', 'vcborsolan', 'MMM1112345', 1, '2018-01-23 22:11:56', '2018-01-23 22:11:56', 'rua do caralho', '43645821821', '666', 5, 666, '1994-08-24 00:00:00', 1, NULL, NULL, 0),
(8, 'teste now', 'now@now.com', 'now', 'now', 1, '2018-02-13 18:53:41', '2018-02-13 18:53:41', 'now n', '123', '123', 1, 123, '1988-09-21 00:00:00', 1, NULL, NULL, 0);
