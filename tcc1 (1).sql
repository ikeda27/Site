...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Jul-2018 às 01:10
...
--
-- Extraindo dados da tabela `cadastro_torneio`
--

INSERT INTO `cadastro_torneio` (`cod_cadastro_torneio`, `flg_ranking`, `tipo_torneio`, `saldo_torneio`, `peso_torneio`, `dt_torneio`, `nome_torneio`, `cod_torneio`, `situacao_id`) VALUES
(1, '1', 2, NULL, 2, NULL, 'JOGO CASEIRO', NULL, 1),
(2, '1', 2, NULL, 3, NULL, 'teste 1', NULL, 1),
(3, '0', 4, NULL, 3, NULL, 'teste 2', NULL, 0),
(4, '0', 2, NULL, 1, NULL, 'teste teste', NULL, 1),
(5, '1', 2, NULL, 2, NULL, 'teste dani final?', NULL, 0);
...
INSERT INTO `estoque` (`qtd_produto`, `cod_clube`, `id_produto`) VALUES
(5, 1, 16);
...
(1, 'site', '2018-02-07', '2018-02-09 01:40:22', '<p>Estamos criando um site</p>\r\n');
...
--
-- Estrutura da tabela `metodos_pgto`
--
...
--
-- Extraindo dados da tabela `metodos_pgto`
--

INSERT INTO `metodos_pgto` (`cod_metodo_pgto`, `descricao_metodo_pgto`) VALUES
(1, 'SALDO EM CONTA'),
(9, 'CHEQUE'),
(8, 'DINHEIRO'),
(4, 'CARTÃƒO'),
(5, 'PROMISSÃ“RIA'),
(6, 'BENS'),
(12, 'MISTO (DINHEIRO + CARTÃƒO)'),
(10, 'MISTO (CHEQUE + DINHEIRO)'),
(11, 'MISTO (CHEQUE + CARTÃƒO)');
...
INSERT INTO `planos` (`id_plano`, `desc_plano`, `flag_plan_ativo`, `vantagens_plano`, `id_clube`) VALUES
(1, 'teste_basico', 1, ' Vantagem zuada', 1),
(2, 'Bronze', 1, 'Vantagens do Plano', 1),
(3, 'Prata', 1, 'Vantagens do Plano', 1),
(4, 'Ouro', 1, 'Vantagens do Plano', 1),
(5, 'Diamante', 1, 'Vantagens do Plano', 1),
(6, '', 0, '', 1),
(8, 'Plano X', 0, ' Vantagem 1 Vantagem 2 Vantagem 3', 1),
(9, '', 0, ' Vantagem 1 Vantagem 2 Vantagem 3', 1),
(12, 'sdfsdfsdfsdfsdf', 1, '', 1),
(13, 'plano teste 21-04', 1, ' Vantagem zuada Vantagem 3 Vantagem 4', 1),
(14, 'plano teste 21-04-2', 1, ' Vantagem zuada Vantagem 3 Vantagem 4', 1);
...
(16, 'teste', '', '', '100', '-', '', '', '17TDIeulhd_GTRHelios016.jpg.ximg.l_full_m.smart.jpg', 1, '2018-04-08 01:05:10', '2018-04-08 00:45:57', 1);
...
--
-- Estrutura da tabela `tipo_torneio`
--
...
--
-- Extraindo dados da tabela `tipo_torneio`
--

INSERT INTO `tipo_torneio` (`cod_tp_torneio`, `nome_tp`) VALUES
(1, 'Freeroll'),
(2, 'Mata a Mata'),
(3, 'Um outro'),
(4, 'E mais um');
...
INSERT INTO `torneio` (`numero_torneio`, `vlr_entrada`, `qtd_max_rebuy`, `vlr_rebuy`, `qtd_max_addon`, `vlr_addon`, `qtd_max_player_mesa`) VALUES
(7, '30', 3, '30', 1, '20', '10'),
(6, '30', 3, '30', 1, '20', '10');
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `login`, `senha`, `nivel_acesso_id`, `created`, `modified`, `endereco`, `documento`, `telefone`, `plano`, `saldo`, `nascimento`, `flag_user_ativo`, `cod_clube`, `cidade`) VALUES
(1, 'Cesar Szpak', 'admin@ikedateste.com.br', 'admin', '123', 1, '2015-09-19 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL),
(2, 'Kelly1', 'kelly@ikedateste.com.br', 'kelly', '123', 2, NULL, '2015-09-26 13:20:53', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL),
(3, 'Gabriely', 'cesarszpak@gmail.com', 'gabriely', '123', 2, '2015-09-20 21:48:49', '2015-09-26 13:21:42', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL),
(6, 'Novo Teste Cadastro V2', 'email@v2.com.br', 'cadv2', '123', 1, '2017-12-14 22:43:49', '2017-12-14 22:43:49', 'rua cadastro v2', '12345678910', '14999999999', 4, '50000', '2017-10-21 00:00:00', 1, 0, NULL),
(7, 'Victor Cesar', 'vorsolan@hotmail.com', 'vcborsolan', 'MMM1112345', 1, '2018-01-23 22:11:56', '2018-01-23 22:11:56', 'rua do caralho', '43645821821', '666', 5, '666', '1994-08-24 00:00:00', 1, 1, NULL),
(8, 'Usuario 21-04', 'usuario21@21.com', 'u21', '123123', 2, '2018-04-21 14:16:33', '2018-04-21 14:16:33', 'usuario 21 ', '212.121.212-12', '(21) 21212-1212', 5, '10.000,00', '21/12/1921', 1, 1, NULL),
(9, 'teste teste teste', 'teste@teste2222.com.br', 'teste222', 'teste222', 1, '2018-04-21 16:51:28', '2018-04-21 16:51:28', 'adfdfdsfsfd', '123.123.123-12', '(12) 31231-2311', 2, '123.123,12', '12/12/2000', 1, 1, NULL),
(10, 'Daniel Guede', 'dani@gmail.com', 'dggoiss', 'dasj4566', 2, '2018-05-18 15:17:50', '2018-05-18 15:17:50', 'Rua abc', '123.344.555-55', '(14) 99888-7777', 3, '0', '13/04/1976', 1, 1, 'Assis'),
(11, 'Daniel2', 'daniel@teste2.com.br', 'testedaniel2', 'qwerty', 1, '2018-07-01 23:28:29', '2018-07-01 23:28:29', '', '', '', 1, '', '', 1, 1, '');
...
INSERT INTO `vantagens` (`id_vantagem`, `desc_vantagem`, `flag_vantagem_ativo`, `id_clube`) VALUES
(1, 'Vantagem 1', 0, 1),
(2, 'Vantagem zuada', 1, 1),
(3, 'Vantagem 3', 1, 1),
(4, 'Vantagem 4', 1, 1),
(5, 'Vantagem 5', 1, 1),
(6, 'Vantagem 6', 1, 1),
(7, 'come cu de curiosos', 1, 1),
(8, 'tttt', 1, 1);
...
INSERT INTO `vendas` (`cod_venda`, `cod_clube`, `cod_cliente`, `pago`, `meio_pgto`, `data_pgto`) VALUES
(1, 1, 7, 'SIM', '4', '03/05/2018'),
(2, 1, 7, 'SIM', '12', '03/05/2018'),
(3, 1, 3, 'SIM', '6', '03/05/2018'),
...
--
-- Estrutura da tabela `venda_dados`
--
...
--
-- Extraindo dados da tabela `venda_dados`
--

INSERT INTO `venda_dados` (`cod_venda`, `cod_produto`, `qtd_produto`, `valor_produto`, `data_venda`) VALUES
(1, 16, 10, '10.50', '2018-04-08'),
(1, 16, 10, '10.50', '2018-04-08'),
(2, 16, 10, '10.50', '2018-04-08'),
(3, 16, 1, '100', '2018-05-03'),
(4, 16, 1, '100', '2018-05-26'),
(5, 16, 1, '100', '2018-05-26'),
(6, 16, 2, '100', '2018-05-26');
...
--
ALTER TABLE `partida`
  ADD PRIMARY KEY (`numero_torneio`,`cod_partida`);
...
--
ALTER TABLE `torneio`
  ADD PRIMARY KEY (`numero_torneio`);
...
--
ALTER TABLE `cadastro_torneio`
  MODIFY `cod_cadastro_torneio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `planos`
  MODIFY `id_plano` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `torneio`
  MODIFY `numero_torneio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `vantagens`
  MODIFY `id_vantagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;COMMIT;
