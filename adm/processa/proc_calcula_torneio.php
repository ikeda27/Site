...
foreach ($players_torneio[0] as $key => $value) {
	...
	$posicao = randomizar_int(1, $qtd_players);
=======
	$cadeira = array( 
				array (	'id_jogador' ,
						'posicao' , 
...
foreach ($cadeira[0] as $key => $value) {
	...
	$mesa=ceil($cadeira['posicao']/$qtd_max_player_mesa);
	$posicao_mesa=(floor($cadeira['posicao']/$qtd_max_player_mesa)*$qtd_max_player_mesa)-$cadeira['posicao'];
=======
				);
